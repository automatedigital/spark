...
CATALOG_CONNECTORS: tuple[CatalogConnectorSpec, ...] = (
    ...
    CatalogConnectorSpec(
        id="firecrawl",
        name="Firecrawl",
        description="Crawl and scrape websites into clean markdown for research and RAG workflows.",
        transport=Transport.SKILL,
        ...
        capabilities=("Web scraping", "Site crawling", "Markdown extraction"),
        setup_steps=(
    ...
    CatalogConnectorSpec(
        id="exa",
        name="Exa",
        description="Neural web search for agents — semantic search, content retrieval, and research.",
        transport=Transport.SKILL,
        ...
        capabilities=("Web search", "Content retrieval", "Research"),
        setup_steps=(
