...
Copies bundled skills from the repo's skills/ directory into ~/.spark/skills/
...
The manifest lives at ~/.spark/skills/.bundled_manifest.
"""
...
def _get_bundled_dir() -> Path:
    ...
    Checks SPARK_BUNDLED_SKILLS env var first (set by Nix wrapper),
...
def _compute_relative_dest(skill_dir: Path, bundled_dir: Path) -> Path:
    ...
    e.g., bundled/skills/mlops/axolotl -> ~/.spark/skills/mlops/axolotl
    """
...
def sync_skills(quiet: bool = False, only: set | None = None) -> dict:
    """
