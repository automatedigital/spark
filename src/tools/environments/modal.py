...
wrapper, while preserving Spark' persistent snapshot behavior across sessions.
"""
...
_SNAPSHOT_STORE = get_spark_home() / "modal_snapshots.json"
...
class ModalEnvironment(BaseEnvironment):
    ...
    def __init__(
        ...
        async def _create_sandbox(image_spec: Any):
            app = await _modal.App.lookup.aio("spark-agent", create_if_missing=True)
