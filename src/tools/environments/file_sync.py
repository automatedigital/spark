...
_FORCE_SYNC_ENV = "SPARK_FORCE_FILE_SYNC"
...
def iter_sync_files(container_base: str = "/root/.spark") -> list[tuple[str, str]]:
    ...
    the hardcoded /root/.spark to *container_base* because the remote
...
class FileSyncManager:
    ...
    def sync(self, *, force: bool = False) -> None:
        ...
        or ``SPARK_FORCE_FILE_SYNC=1`` is set.
