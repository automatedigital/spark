...
~/.spark/skills/. Existing skills (bundled, hub-installed, or user-created)
...
def _find_skill(name: str) -> Optional[Dict[str, Any]]:
    ...
    Searches the local skills dir (~/.spark/skills/) first, then any
...
SKILL_MANAGE_SCHEMA = {
    ...
    "description": (
        ...
        "New skills go to ~/.spark/skills/; existing skills can be modified wherever they live.\n\n"
