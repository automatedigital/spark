...
Trust levels:
  - builtin:   Ships with Spark. Never scanned, always trusted.
...
THREAT_PATTERNS = [
    ...
    (r'\$HOME/\.spark/\.env|\~/\.spark/\.env',
     "spark_env_access", "critical", "exfiltration",
     "directly references Spark secrets file"),
    ...
    (r'\.spark/config\.yaml|\.spark/SOUL\.md',
     "spark_config_mod", "critical", "persistence",
     "references Spark configuration files directly"),
