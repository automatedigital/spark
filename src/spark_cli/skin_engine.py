"""Spark CLI skin/theme engine.

A data-driven skin system that lets users customize the CLI's visual appearance.
Skins are defined as YAML files in ~/.spark/skins/ or as built-in presets.
...
.. code-block:: yaml
    ...
    branding:
      agent_name: "Spark Agent"          # Banner title, status display
      welcome: "Welcome message"          # Shown at CLI startup
      goodbye: "Goodbye! S"              # Shown on exit
      response_label: " Spark "       # Response box header label
...
.. code-block:: python
    ...
    from spark_cli.skin_engine import get_active_skin, list_skins, set_active_skin

    skin = get_active_skin()
    print(skin.colors["banner_title"])    # "#FFD700"
    print(skin.get_branding("agent_name"))  # "Spark Agent"

    set_active_skin("ares")               # Switch to built-in ares skin
    set_active_skin("mytheme")            # Switch to user skin from ~/.spark/skins/
...
Drop a YAML file in ``~/.spark/skins/<name>.yaml`` following the schema above.
...
class SkinConfig:
    ...
    banner_hero: str = ""  # Rich-markup hero art (replaces SPARK_CADUCEUS)
...
_BUILTIN_SKINS: dict[str, dict[str, Any]] = {
    "default": {
        ...
        "branding": {
            ...
            "welcome": "Welcome to Spark Agent! Type your message or /help for commands.",
            "goodbye": "Goodbye!",
            "response_label": " Spark ",
            "prompt_symbol": "> ",
...
def get_active_goodbye(fallback: str = "Goodbye! S") -> str:
...
def get_prompt_toolkit_style_overrides() -> dict[str, str]:
    ...
    input_rule = skin.get_color("input_rule", "#555555")
    ...
    placeholder_color = skin.get_color("placeholder", "#808080")

    return {
        "input-area": prompt,
        "placeholder": f"{placeholder_color} italic",
        "prompt": prompt,
