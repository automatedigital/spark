...
TOOLSETS = {
    ...
    # ==========================================================================
    # Full Spark toolsets (CLI + messaging platforms)
    #
    ...
    "spark-email": {
        "description": "Email bot toolset - interact with Spark via email (IMAP/SMTP)",
        "tools": _SPARK_CORE_TOOLS,
        "includes": []
    },
    ...
    "spark-sms": {
        "description": "SMS bot toolset - interact with Spark via SMS (Twilio)",
        "tools": _SPARK_CORE_TOOLS,
        "includes": []
    },
