...
if tinker_atropos_dir.exists():
    ...
    os.environ['SPARK_QUIET'] = '1'  # Disable temp subdirectory creation
    print(f"📂 Terminal working directory: {tinker_atropos_dir}")
else:
    # Fall back to spark-agent directory if submodule not found
...
def main(
    ...
    """
    # Load config from ~/.spark/config.yaml
