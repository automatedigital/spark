"""Voice mode (record / transcribe / speak) for SparkCLI (mixin).

Extracted from core/cli/__init__.py (Phase 3). Carries the push-to-talk recording,
transcription, TTS playback, and /voice command handling. Combined into SparkCLI
via inheritance.
"""
...
from core.cli.render import _ACCENT, _BOLD, _DIM, _RST, _cprint
