...
class SparkCLI(_CommandHandlersMixin, _DisplayCommandsMixin, _StreamingMixin, _StatusBarMixin, _VoiceMixin, _CallbacksMixin, _TuiMixin, _ModelMixin, _AgentSetupMixin):
    """
