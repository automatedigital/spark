"""Provider-call helpers shared by the AIAgent request paths."""
...
class _ProviderCallMixin:
    """Small provider/request helpers extracted from the AIAgent facade."""
    ...
    def _max_tokens_param(self, value: int) -> dict[str, int]:
        """Return the correct max-token kwarg for the current provider."""
    ...
    def _fire_tool_gen_started(self, tool_name: str) -> None:
        """Notify display layer that the model is generating tool arguments."""
