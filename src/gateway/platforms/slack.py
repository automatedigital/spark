...
class SlackAdapter(BasePlatformAdapter):
    ...
    async def connect(self) -> bool:
        ...
        tokens_file = get_spark_home() / "slack_tokens.json"
        ...
        try:
            ...
            @self._app.command("/spark")
            async def handle_spark_command(ack, command):
                await ack()
            ...
            for _action_id in (
                "spark_approve_once",
                "spark_approve_session",
                "spark_approve_always",
                "spark_deny",
            ):
                    ...
                    "elements": [
                        {
                            ...
                            "style": "primary",
                            "action_id": "spark_approve_once",
                            "value": session_key,
                        },
                        {
                            "type": "button",
                            "text": {"type": "plain_text", "text": "Allow Session"},
                            "action_id": "spark_approve_session",
                            "value": session_key,
                        },
                        {
                            "type": "button",
                            "text": {"type": "plain_text", "text": "Always Allow"},
                            "action_id": "spark_approve_always",
                            "value": session_key,
                        },
                        {
                            "type": "button",
    ...
    async def _handle_approval_action(self, ack, body, action) -> None:
        ...
        choice_map = {
            "spark_approve_once": "once",
            "spark_approve_session": "session",
            "spark_approve_always": "always",
            "spark_deny": "deny",
        }
    ...
    async def _handle_slash_command(self, command: dict) -> None:
        ...
        from spark_cli.commands import slack_subcommand_map
