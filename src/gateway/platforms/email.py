"""
Email platform adapter for the Spark gateway.

Allows users to interact with Spark by sending emails.
...
class EmailAdapter(BasePlatformAdapter):
    ...
    def _send_email(
        ...
        subject = ctx.get("subject", "Spark Agent")
        ...
        msg_id = f"<spark-{uuid.uuid4().hex[:12]}@{self._address.split('@')[1]}>"
