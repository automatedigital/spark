...
def build_plan_path(
    ...
    *,
    ...
    workspace instead of the Spark host's global home directory.
    """
    ...
    return Path(".spark") / "plans" / f"{timestamp}-{slug}.md"
...
def _load_skill_payload(skill_identifier: str, task_id: str | None = None) -> tuple[dict[str, Any], Path | None, str] | None:
    ...
    try:
        ...
        loaded_skill = json.loads(skill_view(normalized, task_id=task_id or ""))
    except Exception:
        return None
...
def _inject_skill_config(loaded_skill: dict[str, Any], parts: list[str]) -> None:
    ...
    If the loaded skill's frontmatter declares ``metadata.spark.config``
    ...
    try:
        ...
        lines = ["", "[Skill config (from ~/.spark/config.yaml):"]
...
def scan_skill_commands() -> dict[str, dict[str, Any]]:
    """Scan ~/.spark/skills/ and return a mapping of /command -> skill info.
    ...
    try:
        ...
        logger.warning("scan_skill_commands failed: %s", e)
