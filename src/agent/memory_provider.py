...
class MemoryProvider(ABC):
    ...
    def initialize(self, session_id: str, **kwargs) -> None:
        ...
        kwargs always include:
          - spark_home (str): The active SPARK_HOME directory path. Use this
            for profile-scoped storage instead of hardcoding ``~/.spark``.
        ...
        kwargs may also include:
          ...
          - agent_workspace (str): Shared workspace name (e.g. "spark").
    ...
    def save_config(self, values: dict[str, Any], spark_home: str) -> None:
        ...
        ``spark_home`` is the active SPARK_HOME directory path.
