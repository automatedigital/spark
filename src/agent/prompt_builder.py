...
ACTION_FIRST_RESPONSE_GUIDANCE = (
    ...
    "when the answer is complete. When a direct question can be answered correctly in "
    "60 words, default to one to three sentences and stay within that limit. Keep "
    "routine status updates to at most two short bullets. For actions, include "
    "verification or the precise "
