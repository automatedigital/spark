...
class TestStreamingAccumulator:
    ...
    @patch("core.run_agent.AIAgent._create_request_openai_client")
    @patch("core.run_agent.AIAgent._close_request_openai_client")
...
class TestStreamingFallback:
    ...
    def test_exhausted_transient_stream_error_propagates(self, mock_close, mock_create):
        ...
        # Should have retried 3 times (default SPARK_STREAM_RETRIES=2 → 3 attempts)
    ...
    def test_sse_connection_lost_retried_as_transient(self, mock_close, mock_create):
        ...
        # Should retry 3 times (default SPARK_STREAM_RETRIES=2 → 3 attempts)
        assert mock_client.chat.completions.create.call_count == 3
