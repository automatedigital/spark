...
def _reload_constants():
    """Reload spark_constants to get a fresh apply_ipv4_preference."""
    import core.spark_constants as spark_constants
    importlib.reload(spark_constants)
    return spark_constants
...
class TestApplyIPv4Preference:
    ...
    def test_patches_getaddrinfo_when_forced(self):
        ...
        assert getattr(socket.getaddrinfo, "_spark_ipv4_patched", False) is True
