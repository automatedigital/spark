...
from spark_cli.auth import PROVIDER_REGISTRY, resolve_provider, resolve_api_key_provider_credentials
from spark_cli.models import _PROVIDER_MODELS, _PROVIDER_LABELS, _PROVIDER_ALIASES, normalize_provider
from spark_cli.model_normalize import normalize_model_for_provider, detect_vendor
...
class TestGeminiAgentInit:
    ...
    def test_gemini_agent_uses_chat_completions(self, monkeypatch):
        ...
        with patch("core.run_agent.OpenAI") as mock_openai:
