"""Tests for the interactive session browser (`spark sessions browse`).
...
class TestSessionBrowseArgparse:
    ...
    def test_browse_subcommand_exists(self):
        """spark sessions browse should be parseable."""
        from spark_cli.main import main as _main_entry
