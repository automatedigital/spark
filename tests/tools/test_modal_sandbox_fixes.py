...
try:
    ...
    pytest.skip("spark-agent tools not importable (missing deps)", allow_module_level=True)
...
class TestToolResolution:
    ...
    def test_terminal_and_file_toolsets_resolve_all_tools(self):
        """Terminal/file tools include the pager required by bounded results."""
...
class TestCwdHandling:
    ...
    def test_home_path_replaced_for_modal(self, monkeypatch):
        ...
        monkeypatch.setenv("TERMINAL_CWD", "/home/dakota/github/spark-agent")
