...
class TestParserRegistry:
    ...
    def test_spark_parser_registered(self):
        parsers = list_parsers()
        assert "spark" in parsers
...
class TestParseResultContract:
    ...
    @pytest.fixture(params=["spark"])  # Add more as needed
    ...
    def test_tool_calls_are_proper_objects(self, parser):
        ...
        # Use spark format since that's universal
