...
# ── exploratory-web-qa skill files ───────────────────────────────────


class TestExploratoryWebQaSkill:
    """Exploratory web QA skill files exist and have correct structure."""
    ...
    def test_report_template_exists(self):
        assert os.path.exists(
            os.path.join(
                self.skill_dir, "templates", "exploratory-web-qa-report-template.md"
            )
        )
    ...
    def test_skill_md_has_frontmatter(self):
        ...
        assert "name: exploratory-web-qa" in content
