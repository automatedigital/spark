...
def _make_adapter(require_mention=None, free_response_chats=None, mention_patterns=None, ignored_threads=None):
    ...
    adapter._bot = SimpleNamespace(id=999, username="spark_bot")
...
def _mention_entity(text, mention="@spark_bot"):
...
def test_group_messages_can_require_direct_trigger_via_config():
    ...
    assert adapter._should_process_message(_group_message("hi @spark_bot", entities=[_mention_entity("hi @spark_bot")])) is True
