...
class TestToolsetConsistency:
    ...
    def test_spark_platforms_share_core_tools(self):
        """All spark-* platform toolsets should have the same tools."""
        platforms = ["spark-cli", "spark-telegram", "spark-discord", "spark-whatsapp", "spark-slack", "spark-signal", "spark-homeassistant"]
