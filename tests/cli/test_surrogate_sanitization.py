...
class TestRunConversationSurrogateSanitization:
    ...
    @patch("core.run_agent.AIAgent._build_system_prompt")
    @patch("core.run_agent.AIAgent._interruptible_streaming_api_call")
    @patch("core.run_agent.AIAgent._interruptible_api_call")
