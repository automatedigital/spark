"""Tests for SparkCLI initialization -- catches configuration bugs
...
class TestMaxTurnsResolution:
    ...
    def test_env_var_max_turns(self):
        ...
        cli_obj = _make_cli(env_overrides={"SPARK_MAX_ITERATIONS": "42"})
    ...
    def test_history_shows_recent_sessions_when_current_chat_is_empty(self, capsys):
        ...
        cli._session_db.list_sessions_rich.return_value = [
            ...
            },
            {
                ...
                "title": "Checking Running Spark Agent",
                "preview": "check running gateways for spark agent",
                "last_active": 0,
            },
        ]
        ...
        assert "Checking Running Spark Agent" in output
...
class TestRootLevelProviderOverride:
    ...
    def test_normalize_root_model_keys_moves_to_model(self):
        ...
        from spark_cli.config import _normalize_root_model_keys
