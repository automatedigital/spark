...
class TestParseReasoningConfig(unittest.TestCase):
    ...
    def _parse(self, effort):
        from core.cli import _parse_reasoning_config
...
class TestReasoningPreviewBuffering(unittest.TestCase):
    ...
    @patch("core.cli.streaming_mixin._cprint")
    ...
    @patch("core.cli.streaming_mixin._cprint")
    @patch("core.cli.shutil.get_terminal_size", return_value=SimpleNamespace(columns=50))
    ...
    @patch("core.cli.shutil.get_terminal_size", return_value=SimpleNamespace(columns=60))
