...
class TestSaveConfigValueAtomic:
    ...
    def test_calls_atomic_yaml_write(self, config_env, monkeypatch):
        ...
        monkeypatch.setattr("core.utils.atomic_yaml_write", mock_atomic)

        from core.cli import save_config_value
    ...
    def test_file_not_truncated_on_error(self, config_env, monkeypatch):
        ...
        monkeypatch.setattr("core.utils.atomic_yaml_write", exploding_write)
