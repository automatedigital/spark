...
def register_parser(name: str):
    ...
    Usage:
        @register_parser("spark")
        class SparkToolCallParser(ToolCallParser):
            ...
    """
...
def get_parser(name: str) -> ToolCallParser:
    ...
    Args:
        name: Parser name (e.g., "spark", "mistral", "llama3_json")
...
from environments.tool_call_parsers.spark_parser import SparkToolCallParser  # noqa: E402, F401
