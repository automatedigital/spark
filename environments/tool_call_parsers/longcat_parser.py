...
Same as Spark but uses <longcat_tool_call> tags instead of <tool_call>.
Based on VLLM's LongcatFlashToolParser patterns.
"""
...
class LongcatToolCallParser(ToolCallParser):
    ...
    Identical logic to Spark, just different tag names.
    """
