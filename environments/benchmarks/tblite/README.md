...
- **Dataset (ours):** [AutomateDigital/openthoughts-tblite](https://huggingface.co/datasets/AutomateDigital/openthoughts-tblite)
...
| Setting        | TB2                              | TBLite                                  |
|----------------|----------------------------------|-----------------------------------------|
| Dataset        | `AutomateDigital/terminal-bench-2`  | `AutomateDigital/openthoughts-tblite`      |
| Tasks          | 89                               | 100                                     |
