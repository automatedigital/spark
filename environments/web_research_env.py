...
Inspired by: GroceryMind — production Spark agent doing live web research
             across German grocery stores (firecrawl + spark-agent)
"""
...
# Ensure spark-agent root is on path
...
class WebResearchEnvConfig(SparkAgentEnvConfig):
...
class WebResearchEnv(SparkAgentBaseEnv):
    """
