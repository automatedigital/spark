...
Usage:
    ...
    python scripts/contributor_audit.py --since-tag v2026.4.8 --release-file RELEASE_v0.10.0.md
"""
...
IGNORED_PATTERNS = [
    ...
    re.compile(r"^Spark\s+(Agent|Audit)$", re.IGNORECASE),
...
IGNORED_EMAILS = {
    ...
    "spark@automatedigital.ai",
    "spark-audit@example.com",
    "spark@habibilabs.dev",
}
