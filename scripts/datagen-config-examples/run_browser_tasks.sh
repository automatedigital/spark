...
#
# Prerequisites:
#   - OPENROUTER_API_KEY in ~/.spark/.env
#   - BROWSERBASE_API_KEY in ~/.spark/.env (for browser tools)
#   - A dataset JSONL file with one {"prompt": "..."} per line
#
# Usage:
#   cd ~/.spark/spark-agent
#   bash scripts/datagen-config-examples/run_browser_tasks.sh
#
