# Streaming LLM Response Support for Spark Agent
...
```
SPARK_STREAMING_ENABLED=true    # Master switch via env
```
...
try:
    ...
    pass
# Env var override
if os.getenv("SPARK_STREAMING_ENABLED", "").lower() in ("true", "1", "yes"):
...
| `spark_cli/config.py` | 1 | +streaming config defaults |
