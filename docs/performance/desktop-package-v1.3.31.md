...
[`30714988411`](https://github.com/automatedigital/spark/actions/runs/30714988411)
completed successfully against exact clean replay commit `4f380488`. It produced
the unsigned NSIS installer `Spark_1.3.31_x64-setup.exe`: 42,714,330 bytes,
SHA-256
`a56cae1319f7c23619075cca74fd46b1ad6514ace88ba1d6f93642b8cdf28ed5`.
The v1.3.30 installer was 42,564,153 bytes with SHA-256
`bb43d86a6fc53eccd9e4ab0dae5472b6ba45ff7d947bb567f696272ea91c8dd1`.
The installer grew by 150,177 bytes (0.35%); package size did not improve.

The workflow launched the actual packaged `target/release/spark.exe` with an
isolated `SPARK_HOME`. Initial process start to healthy desktop status measured
19.548 seconds on the fresh runner; full relaunch to a changed healthy backend
instance measured 3.229 seconds. The first prepare phase passed frontend/backend health,
...
| Windows package | Native unsigned v1.3.31 installer, timed launch, and lifecycle passed in run `30714988411` at exact clean replay commit `4f380488`. |
