...
Built for [Spark Agent](https://github.com/automatedigital/spark). Usable in any coding agent. Canonical source lives here; synced to [`automatedigital/spark/skills/creative/ascii-video`](https://github.com/automatedigital/spark/tree/main/skills/creative/ascii-video) via PR.
