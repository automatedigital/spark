...
```bash
python3 -m pyfiglet "SPARK" -f slant | boxes -d stone
# Or without pyfiglet installed:
curl -s "https://asciified.thelicato.io/api/v2/ascii?text=SPARK&font=Slant" | boxes -d stone
```
